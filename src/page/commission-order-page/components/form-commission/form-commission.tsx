...
export const FormCommission = (props: FormCommissionType) => {
	...
	<div className="klz-commissions-order__form-body">
		<form onSubmit={(e) => handleSubmit(e)}>
			<Select 
				name="select-delivery-days"
				label={FORM_COMMISSIONS.deliveryDate}
			...
			<button className="klz-commissions-order__form-body__button">
				<span className="klz-commissions-order__form-body__button-add-to-cart">{FORM_COMMISSIONS.addToCart}</span>
				<div className="klz-commissions-order__form-body__button-description">
					<span className="klz-commissions-order__form-body__button-description__subtotal">{FORM_COMMISSIONS.subtotal}</span>
					<span className="klz-commissions-order__form-body__button-description__price">70€</span>
					<img 
